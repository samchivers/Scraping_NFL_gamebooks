...
list.files(path = "C:/Users/adrian-boss/Documents/GitHub/Scraping_NFL_gamebooks/pdfs/2019") %>% length()
list.files(path = "C:/Users/adrian-boss/Documents/GitHub/Scraping_NFL_gamebooks/pdfs/2018")%>% length()

# 2019 Season

#Get list of PDFs
lst_files<-list.files(path = "C:/Users/adrian-boss/Documents/GitHub/Scraping_NFL_gamebooks/pdfs/2019/")
...
for (i in 1:length(lst_files)){
  ...
  file<-pdf_text(paste0("C:/Users/adrian-boss/Documents/GitHub/Scraping_NFL_gamebooks/pdfs/2019/",file_name))
  ...
  first_defending_team_q3 <- Q3%>% sub('.*Receive,', '', .)%>% str_trim()%>%strsplit(" ") %>% unlist() %>% .[2]
  team_defending_string_q3 <- Q3 %>%strsplit("[,]") %>% unlist() %>% tail(., n=1) %>% str_trim()
...
write.csv(output_df,'C:/Users/adrian-boss/Documents/GitHub/Scraping_NFL_gamebooks/CSVs/output_direction19.csv',row.names = F)
...
#Get list of PDFs
lst_files<-list.files(path = "C:/Users/adrian-boss/Documents/GitHub/Scraping_NFL_gamebooks/pdfs/2018")
...
for (i in 1:length(lst_files)){
  #Get file
  file_name<-lst_files[i]
  file<-pdf_text(paste0("C:/Users/adrian-boss/Documents/GitHub/Scraping_NFL_gamebooks/pdfs/2018/",file_name))
    ...
    def_direction_q3 = if_else(str_detect(tolower(team_defending_str_q3),'south'),'south',
                               if_else(str_detect(tolower(team_defending_str_q3),'north'),'north',
                                       if_else(str_detect(tolower(team_defending_str_q3),'east'),'east',
                                               if_else(str_detect(tolower(team_defending_str_q3),'west'),'west',''))))
    ,
    game_id=paste(away_team,home_team,'2018',sep='_')
  ) %>%select(-team_defending_str_q1,-team_defending_str_q3)
...
#Create Output Dataframe
output_df <- dplyr::bind_rows(output)
write.csv(output_df,'C:/Users/adrian-boss/Documents/GitHub/Scraping_NFL_gamebooks/CSVs/output_direction18.csv')
